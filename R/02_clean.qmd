...
We still have too much genes (57825) so we want to see which genes are useless
...
Now we want to visualize this new variable to know what threshold we are going to use to select the relevant genes
