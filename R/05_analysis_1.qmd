...
PCA is more informative when applied to genes that show substantial\
variation across samples. We therefore select the top 500 most\
variable genes based on the variance of `log2_expression`.
