...
The new size is 6'073'353 rows and 53 columns.
...
ggsave("../results/04_age_distribution.png")
```
...
ggsave("../results/04_age_tumorstage.png")
```
...
ggsave("../results/04_log2_expression.png")
```
...
ggsave("../results/04_histogram_expression.png")
```
