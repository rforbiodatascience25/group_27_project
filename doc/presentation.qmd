...
After removing genes with zero or extremely low expression, the overall mean expression shifts upward and the distribution becomes more symmetric.

This confirms that the cleaning part removed uninformative genes and produced a clean, well-behaved dataset suitable for downstream statistical analysis.

![](images/gene%20exp%20distribution)
:::
:::::
...
![](../results/figostages_analysis1.png){width="70%"}

![](../results/IS_ethnicity_analysis1.png){width="85%"}
:::
:::::
...
::: column
Ajouter ces plots une fois qu'ils sont déplacés plots/07_volcano_alive_vs_dead.png style="background:white; width:80%; plots/07_top3_boxplots_alive_vs_dead.png" style="background:white; width:80%;
:::
:::::
