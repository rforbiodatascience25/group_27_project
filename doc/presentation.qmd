...
1. *Clinical variables distributions*{style="color:#f8a47d;"}  
   When exploring the clinical variables, we found that the dataset is **extremely unbalanced**:  
   most patients are late‐stage high-grade serous ovarian cancer, with very similar ages and clinical characteristics.  
   
   → This **lack of variability** reduces our ability to detect strong associations.

2. *PCA of gene expression*{style="color:#f8a47d;"}  
...
3. *Differential expression*{style="color:#f8a47d;"}  
   Differential expression confirmed this: out of ~14’000 tested genes, **only two** remained significant after FDR correction.  
